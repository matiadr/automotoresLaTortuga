...
Public Class formPrincipal
    ...
    Private Sub GastosPorVehiculoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GastosPorVehiculoToolStripMenuItem.Click
        formReporteGastoVehiculo.ShowDialog()
    End Sub
End Class
